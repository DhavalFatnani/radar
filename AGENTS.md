...
This project is indexed by GitNexus as **radar** (2127 symbols, 4328 relationships, 161 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
