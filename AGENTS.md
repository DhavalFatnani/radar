...
This project is indexed by GitNexus as **radar** (2651 symbols, 5498 relationships, 201 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
