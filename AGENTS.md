...
This project is indexed by GitNexus as **radar** (1973 symbols, 3920 relationships, 140 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
