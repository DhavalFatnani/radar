...
This project is indexed by GitNexus as **radar** (2708 symbols, 5642 relationships, 205 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
